...
//        for (int i = 0; i < hand.length; i++) {
    ...
    private static void printInfo() {
        ...
        System.out.println("My name is Natalee, but you can call me Nat");
        System.out.println();

        System.out.println("My career ambitions:");
        System.out.println("-- To get a good job");
        System.out.println("-- Have a good semester 2!");
        System.out.println();
